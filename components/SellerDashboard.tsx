        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-indigo-600 text-white p-4 rounded-xl shadow-lg mb-8 flex items-center justify-between flex-wrap gap-4">
               <div className="flex items-center gap-3">
                 ...
                 <div>
                   ...
                   <p className="text-xs sm:text-sm text-indigo-100">You have {trialDaysLeft > 0 ? trialDaysLeft : 0} days remaining. Full access enabled.</p>
                 </div>
               </div>
             ...
             <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-r-lg mb-8" role="alert">
                <div className="flex">
                    ...
                    <div>
                        ...
                        <p className="text-sm">Your shop is paused and products are hidden. Please renew your subscription to continue selling.</p>
                    </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            ...
            {canAddProducts && (
              <button 
                ...
                className="bg-brand-500 hover:bg-brand-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 font-medium shadow-sm transition-all"
              >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6 border-b border-gray-100 flex justify-between items-center">
              <h3 className="text-lg font-semibold text-gray-800">Your Inventory ({products.length})</h3>
